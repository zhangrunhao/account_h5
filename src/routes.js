...
export default [
  ...
  },
  {
    ...
    component: lazy(() =>
      import("./page/borrow-lend-edit/borrow-lend-edit.jsx")
    ),
  },
  {
    path: "/borrow-lend-detail/:id",
    component: lazy(() =>
      import("./page/borrow-lend-detail/borrow-lend-detail.jsx")
    ),
  },
  {
    path: "/repayment-receive-edit/:id/:targetId",
    component: lazy(() =>
      import("./page/repayment-receive-edit/repayment-receive-edit.jsx")
    ),
  },
  {
    path: "/home",
  ...
  {
    path: "/about",
    component: lazy(() => import("./page/about/about.jsx")),
  },
  {
    path: "/",
    component: lazy(() => import("./page/bill/bill.jsx")),
  ...
  {
    path: "/todo-list",
    component: lazy(() => import("./page/todo-list/todo-list.jsx")),
  },
];
